  ...
  return (
    <div className="space-y-6">
      <div className="bg-white p-4 sm:p-6 rounded-2xl border border-slate-200 shadow-sm">
        <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-4">Invoice Layout</h3>
        <div>
      ...
      <div className="bg-white p-4 sm:p-6 rounded-2xl border border-slate-200 shadow-sm">
        <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-1">Terms & Conditions</h3>
      ...
      <div className="flex justify-end">
        <button
          ...
          className="w-full sm:w-auto bg-slate-900 text-white px-6 py-2.5 rounded-xl hover:bg-slate-800 shadow-lg font-bold"
        >
          Save Changes
        </button>
      </div>
